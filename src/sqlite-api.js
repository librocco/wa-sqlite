...
export function Factory(Module) {
  ...
  sqlite3.column_blob = (function() {
    ...
    return function(stmt, iCol) {
      ...
      // NOTE: this differs from the original implementation as it was causing bugs
      // related to copy (here) or merely a view (what we would get by calling .subarray)
      // see: https://github.com/rhashimoto/wa-sqlite/issues/69
  ...
  // NOTE: The following section includes functions that don't exist in the original, but are here for backwards 
  // compatibility, as removing any of those would require rewrites to the depending projects (e.g. vlcn.io/js)
